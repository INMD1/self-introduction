...
const More = () => {
  return (
    <div className="p-10 sm:p-48" style={{ backgroundColor: "#749BC2" }}>
      <div className="pb-10">
        <center>
          <p className="text-4xl md:text-6xl font-bold">Some More?</p>
          <br/>
          <Text as="b" fontSize="xl">
            좀 더 저에 대해서 알고 싶나요? 밑에 사이트를 방문해주세요!
          </Text>
        </center>
      </div>
              ...
              <Center>
                <VStack>
                  ...
                  <Link href="https://github.com/INMD1">
                    <Text>https://github.com/INMD1</Text>
                  </Link>
              ...
              <Center>
                <VStack>
                  ...
                  <Link href="https://amview.powerinmd.com">
                    <Text>https://amview.powerinmd.com</Text>
                  </Link>
                  <Text>코딩 문제를 풀고 소스코드를 공개하는 사이트</Text>
