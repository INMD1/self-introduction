...
const skills = [
    ...
    "Node.js", "Nest.js", "Vue",
    "Python", "PHP", "MySQL", "Git", "Pfsense", "Openstack", "Docker"
];
        ...
        <section id="skills" className="bg-[#010102] py-24 px-6">
            <div className="max-w-6xl mx-auto">
                <motion.div
                    ...
                    className="mb-16"
                >
                    <p className="text-[#5e6ad2] text-xs font-bold uppercase tracking-widest mb-3">About</p>
                    <h2 className="text-4xl lg:text-5xl font-semibold text-[#f7f8f8] mb-4">기술 스택 & 소개</h2>
                    <p className="text-[#8a8f98] max-w-md text-sm leading-relaxed">저에 대한 정보와 기술 스택을 소개합니다.</p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-semibold text-[#f7f8f8] mb-3">Full Stack Developer</h3>
                        ...
                        <div>
                            <div className="flex justify-between mb-2">
                                <span className="text-xs text-[#62666d] uppercase tracking-widest font-medium">Skill Level</span>
                                <span className="text-xs text-[#5e6ad2] font-mono font-medium">85%</span>
                            </div>
                    ...
                    >
                        ...
                        <div className="mt-10">
                            ...
                            <p className="text-[#62666d] text-sm mt-0.5 group-hover:text-[#8a8f98] transition-colors">@INMD1</p>
                        </div>
                    </motion.a>
                    ...
                    >
                        ...
                        <div className="mt-10">
                            ...
                            <p className="text-[#62666d] text-xs mt-0.5 group-hover:text-[#8a8f98] transition-colors break-all">lyw514549@gmail.com</p>
                        </div>
                    </motion.a>
                    ...
                    >
                        <div className="flex items-center gap-2 mb-6">
                            ...
                            <p className="text-xs text-[#8a8f98] uppercase tracking-widest font-bold">Tech Stack</p>
                        </div>
