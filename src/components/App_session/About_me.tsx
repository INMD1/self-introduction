    ...
    return (
        <>
            ...
            < motion.section id="about" className="py-24 scroll-mt-20 " variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true }
                ...
                <div className="grid md:grid-cols-5 gap-8 md:gap-12 justify-items-center-safe ">
                    <div className="md:col-span-3">
                        <h2 className="text-5xl font-bold tracking-tight mb-4">About Me</h2>
                        <img
                            src={about2}
                            alt="코딩하는 모습"
                            className="rounded-xl shadow-lg w-full h-auto object-cover block sm:hidden mt-10 mb-10"
                        />
                    ...
                    <div className="md:col-span-2 hidden sm:block w-[20em]">
                        <img
                            src={about}
                            alt="코딩하는 모습"
